...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => ['isAdmin'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
        ...
        // transaksi
        // products
        Route::resource('transaction', \App\Http\Controllers\Admin\TransaksiController::class);

        // part apriori
        Route::get('/apriori', [\App\Http\Controllers\Admin\TransaksiController::class, 'apriori'])->name('apriori');
        Route::post('/apriori/analisa/proses', [TransaksiController::class, 'analisaapriori']);
        Route::get('/hasil/apriori', [TransaksiController::class, 'berandaPage']);
        Route::get('/apriori/analisa/hasil/{kdPengujian}', [TransaksiController::class, 'hasilAnalisa']);
    });
});
